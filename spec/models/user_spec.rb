  ...
  describe 'ユーザー新規登録' do
    context '新規登録できる時' do
      it 'nicknameとemail,passwordとpassword_confirmation,
            last_nameとfirst_name,last_name_kanaとfirst_name_kana,birthdayが存在すれば登録できる' do
    ...
    context '新規登録ができない時' do
      ...
      it 'last_nameが全角（漢字・ひらがな・カタカナ）以外では登録できない' do
        @user.last_name = 'ﾔﾏﾀﾞ'
        @user.valid?
        expect(@user.errors.full_messages).to include 'Last name Full-width katakana characters'
      end
